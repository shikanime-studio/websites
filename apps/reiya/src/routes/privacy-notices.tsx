...
export const Route = createFileRoute("/privacy-notices")({
  component: PrivacyNoticesPage,
});

function PrivacyNoticesPage() {
  return (
    <article className="prose fadein mx-auto mt-10 mb-6 max-w-none">
      <h1>PRIVACY NOTICE</h1>
      <b>Last updated September 25, 2023</b>
      <section>
        <p>
          This privacy notice for Shikanime Studio ('we', 'us' , or 'our'),
        ...
        <ul>
          <li>
            Visit our website at https://reiya.shikanime.studio/, or any website
      ...
      <section>
        <ol>
          ...
          <li>
            <a href="#what-legal-bases-do-we-rely-on-to-process-your-information">
      ...
      <section>
        ...
        <p>
          ...
          register with us using your existing social media user details, like
          your Facebook, Twitter, or other social media user. If you choose to
      ...
      <h2 id="how-do-we-handle-your-social-logins">
        HOW DO WE HANDLE YOUR SOCIAL LOGINS?
      </h2>
      <section>
        <p>
          <b>In Short: </b>If you choose to register or log in to our Services
          using a social media user, we may have access to certain information
          about you.
        </p>
        <p>
          Our Services offer you the ability to register and log in using your
          third-party social media user details (like your Facebook or Twitter
      ...
      <section>
        ...
        <p>
          ...
          usering, or other legal requirements).
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          ...
          been collected, we will deactivate the user and take reasonable
      ...
      <section>
        <p>
          ...
          information. You may review, change, or terminate your user at any
          time.
        </p>
        <p>
          ...
          restrict the processing of your personal information; (vi) if
        ...
        <p>
          ...
          email us at contact@shikanime.studio.
        </p>
      </section>
      ...
      <section>
        <p>
          ...
          at{" "}
          <a href="mailto:contact@shikanime.studio">
            {" "}
            contact@shikanime.studio{" "}
          </a>
          .
