...
This app is a minimal reverse proxy Worker intended to sit in front of a
Tailscale Funnel origin (Tailnet HTTPS host).

- Default upstream: `https://copyparty.taila659a.ts.net`
- Config override: `TARGET_HOST` (Worker env var)
...
If the application uses Durable Objects or Workflows, refer to the relevant best
practices:
