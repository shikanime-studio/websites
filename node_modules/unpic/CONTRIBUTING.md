...
1. A TypeScript file containing the implementation
   ...
   and options.
1. A test file (`src/providers/[provider].test.ts`)
1. Example URLs in `src/demo/examples.json`
1. Detection domains or paths in `data` if appropriate
1. Adding to the types and exports in:
...
1. Check test files for patterns
1. Open an issue for discussion
1. Ask questions in pull requests
