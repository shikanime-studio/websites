...
[![bundle size](https://deno.bundlejs.com/badge?q=regex-utilities&treeshake=%5B*%5D)](https://bundlejs.com/?q=regex-utilities&treeshake=%5B*%5D)
...
- If a function is provided, it receives two arguments:
  ...
  1. An object with extended details (`context` and `negated`) about where the match was found.
