...
1. Full Unicode/IDNA support
1. Support parsing email addresses
1. Detect IPv4 and IPv6 addresses
1. Continuously updated version of the public suffix list
1. **TypeScript**, ships with `umd`, `esm`, `cjs` bundles and _type definitions_
1. Small bundles and small memory footprint
1. Battle tested: full test coverage and production use
