...
1. Run `yarn dev` in the root to get auto-building for all the sub-packages whenever you modify anything.
1. Navigate to one of the sub-packages (in the `packages` folder) where you'd like to make a change.
1. Patch the code and run `yarn test` to run the tests, make sure they pass before you commit anything.
1. Push the code and create a pull request.
